        ...
        switch (mode) {
            ...
            case 3:
                ...
                if (match) {
                    ...
                    metarObject.visibility = MetarParserHelpers.getVisibility(match[3] && match[3] === "SM" ? miles : convert.metersToMiles(meters), match[3] && match[3] === "SM" ? convert.milesToMeters(miles) : meters);
                    mode = 4;
                }
